...
*/
async function wootingConnectPrev() : Promise<Array<WootingKeyboard>> {
...
async function wootingConnectNew() : Promise<Array<WootingKeyboard>> {
    return new Promise(async (resolve, reject) => {
        // Refresh list
...
class WootingKeyboard {
    ...
    constructor(device? : HIDDevice) {
        ...
        this.device.addEventListener("inputreport", event => {
            ...
            let newBuffer : Map<keys, bigint> = new Map()
    ...
    addKeyListener(key : keys, f : Function) {
        window.addEventListener("KeyboardAnalog", function (event : CustomEvent) {
